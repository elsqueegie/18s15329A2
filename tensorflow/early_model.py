...
def load_data(input_path, dataset_type, image_size):
    ...
    return DataSet(images, labels, img_names)
...
def read_train_sets(input_path, image_size):
    ...
    data_sets.val = load_data(input_path, 'vali', image_size)
...
print(len(data.val.images))

num_classes = len(set(data.train.labels))
...
#TODO remove following two CONV layers    
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        x_valid_batch, y_valid_batch = data.val.next_batch(batch_size)
